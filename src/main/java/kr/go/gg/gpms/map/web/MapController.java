...
public class MapController extends BaseController{
	...
	public String getImageFromBase64test(HttpServletRequest request, HttpServletResponse res, Model model) throws Exception {
	...
	public String getImageFromBase64test2(HttpServletRequest request, HttpServletResponse res, Model model) throws Exception {
