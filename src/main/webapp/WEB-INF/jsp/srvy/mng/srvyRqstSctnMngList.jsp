...
function fn_select_route_nDirect(route_no){
	...
	MAP.fn_get_selectFeatureByAttrMulti(parent.parent.gMap, tables_base, fields_base, values_base, null, "OR", attribute_base, false, 0, 1);
	...
	<div class="fl bgsch">
	    ...
	    <div class="schbx mt10">
	        <ul class="sch">
	            <li class="wid100">
	                <label>도로등급</label>
	                <select id="ROAD_GRAD" name="ROAD_GRAD" alt="도로등급" onchange="fn_change_roadNo();" style="width:70px;" class="input">
