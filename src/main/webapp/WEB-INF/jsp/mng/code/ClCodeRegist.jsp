	...
	<div class="ConBx">
		<div class="Pop_Section">
						...
						<table class="tbview" summary="분류코드 정보를 등록/수정합니다.">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="number" id="PRIOR_RANK"
										name="PRIOR_RANK" min="1" max="9999" class="iptxt"
										value="${clCodeVO.PRIOR_RANK}" /> <form:errors
											path="PRIOR_RANK" /></td>
								</tr>
			...
			<div class="btnbx" style="margin-right: 15px;">
				<a href="#" class="schbtn" onclick="document.getElementById('clcode_Regist-form').reset(); return false;">초기화</a>
				<a href="#" class="schbtn" onclick="check = false; fn_clcode_save(); return false;">등록</a>
...
function fn_clcode_save() {	
	...
	vform.find('#CL_CODE').val(COMMON_LANG.trimdata( vform.find('#CL_CODE').val()).toUpperCase());
	...
	if( confirm('<spring:message code="warn.insert.msg" />') ) {
		...
		var action = '<c:url value="/api/clcode/addClCode.do" />';
