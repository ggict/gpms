...
<body>
	<div id="loginwrap-pothole">
	<img src="<c:url value='/images/login_logo.png'/>" alt="경기도" class="glogo" />
		<div class="login">
	        <img src="<c:url value='/images/login_systitle.png'/>" alt="경기도로 모니터링단 시스템" class="logo-pothole" id="goodLogo" />
	        <div class="loginbx">
            	...
            	<form name="loginFrm" id="loginFrm" method="post" action="">
		            ...
		            <ul class="form">
		                ...
		                <li class="pt10 tr">
		                    ...
		                    <a href="#" onclick="fn_selUserInfoPth()">아이디/비밀번호 찾기</a>
		                </li>
		            </ul>
		        </form>
	        </div>
	        <div class="loginCon">
	            ...
	            <ul class="bn">
	                ...
	                <li><a href="#"><img src="<c:url value='/images/bn_login4.gif'/>" alt="경기도 포장관리시스템(PMS)" title="경기도 포장관리시스템(PMS)" onclick="location.href='<c:url value="/main.do"/>'" /></a></li>
	                <%-- <li><a href="#"><img src="<c:url value='/images/bn_login4.gif'/>" alt="경기도 포장관리시스템(PMS)" title="경기도 포장관리시스템(PMS)" onclick="alert('접근권한이 없습니다.'); return;" /></a></li> --%>
	            </ul>
	        </div>
	    </div>
	    <!-- 공통 (START)-->
		...
		<!-- 공통 (END)-->
	    <!-- footer start -->
        <div id="loginfooter">© 2017 GYEONGGI PROVINCE All Rights Reserved.
            <span><img src="<c:url value='/images/ic_footer.png'/>" alt=""  class="mr5 vm"/>기능오류 및 문의 : 경기도청 도로관리과 (031-8030-3974) </span>
        </div>
        <!-- footer end -->
	</div>
