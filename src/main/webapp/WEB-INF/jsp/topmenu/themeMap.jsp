...
<body id="wrap" class="right-tool thememap">
        ...
        <div class="titbx mt10 mb10" id="MV_GNLSTTUS_SECT">
            ...
            <div>
                ...
                <div class="titbx pt5 pl5 pr5 pb5" id="MV_GNLSTTUS_SECT_2019">
                    <h4>
                        <a href="#" class="tLayer"><img src="<c:url value='/images/thememap/map_off.png'/>" alt="off" class="mt5 mr10 onoff off" title="2019년도 포장상태 평가정보 지도조회 200m (섹션)" style="position: relative; top: -4px;" /></a> 2019년도 평가정보
                    </h4>
                    <div>
                        <ul class="legend">
                            <li class="tRule"><span class="smcircle" style="background-color:#00b050"></span><span class="rNameKor">8.00 이상</span></li>
	...
	var themeList = {
	        ...
	        "MV_GNLSTTUS_SECT_2019"    : "Section셀_포장상태_2019",
	    ...
	    if ( parent.themeFlag == 0 ) {
	        ...
	        for ( var i = 0; i < sld.length; i++ ) {
	            ...
	            if  ( name == "MV_SRVYDTA_10_2019" || name == "MV_SRVYDTA_10_2018" || name == "MV_SRVYDTA_10_2017"
	            		|| name == "MV_GNLSTTUS_SECT_2019" || name == "MV_GNLSTTUS_SECT_2018" || name == "MV_GNLSTTUS_SECT_2017"
        ...
        if(!_bOff) {
        	if(	sLayerNmEng == "MV_SRVYDTA_10_2019" ||
        		sLayerNmEng == "MV_SRVYDTA_10_2018" ||
               	...
               	sLayerNmEng == "MV_GNLSTTUS_SECT_2019" ||
