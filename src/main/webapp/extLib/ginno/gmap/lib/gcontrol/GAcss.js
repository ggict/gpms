    	...
    	if(result.length > 0) {
    		...
    		if(searchPoint.length > 0) {
                ...
                if (end.length > 0) {
                    ...
                    if (x.length >= 0) {
                    	text = (x[0].text ? x[0].text : x[0].textContent);
                        obj.res.searchPoint.end.x = text;
                    }
                    if (y.length >= 0) {
                    	text = (y[0].text ? y[0].text : y[0].textContent);
                ...
                if (obj.res.searchPoint.start.x - obj.res.searchPoint.end.x > 0) {
                    obj.res.searchPoint.dist.signX = -1;
                } else {
                    obj.res.searchPoint.dist.signX = 1;
                }
                if (obj.res.searchPoint.start.y - obj.res.searchPoint.end.y > 0) {
                    obj.res.searchPoint.dist.signY = -1;
                } else {
                    obj.res.searchPoint.dist.signY = 1;
                }
