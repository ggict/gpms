 ...
 *  - <OpenLayers.Control>
 */
GFeaturePopups = OpenLayers.Class(OpenLayers.Control, {

    /**
     * APIProperty: mode
     * To enable or disable the various behaviors of the control.
     *
     * Use bitwise operators and one or more <GFeaturePopups>:
     ...
     *
     * Default is <GFeaturePopups.DEFAULT>.
     */
    mode: null,
    ...
    initialize: function(options) {
        ...
        this.popupObjs =
            GFeaturePopups_Utils.createPopupObjs(
    ...
    addLayerToControl: function(layer, options) {
        ...
        if (!layerObj) {
            ...
            layerObj = new GFeaturePopups.Layer(
                                                         this, layer, options);
    ...
    refreshLayers: function(useCursorLocation) {
        ...
        for (var layerId in this.layerObjs) {
            ...
            if (layerObj.active) {
                ...
                if (layerPopObjs) {
                    if(r.invalid) {
                        GFeaturePopups_Utils.showListPopup(
                            layerPopObjs, [{
                                layerObj: layerObj,
 ...
 *     <UNSELECT_ON_CLOSE>.
 */
GFeaturePopups.NONE = 0;
GFeaturePopups.CLOSE_ON_REMOVE = 1;
GFeaturePopups.SAFE_SELECTION = 2;
GFeaturePopups.CLOSE_ON_UNSELECT = 4;
GFeaturePopups.CLOSE_BOX = 8;
GFeaturePopups.UNSELECT_ON_CLOSE = 16;
GFeaturePopups.DEFAULT =
    GFeaturePopups.SAFE_SELECTION |
    GFeaturePopups.CLOSE_ON_UNSELECT |
    GFeaturePopups.CLOSE_BOX |
    GFeaturePopups.UNSELECT_ON_CLOSE;

/**
 * Namespace: FeaturePopups_Utils
 */
 GFeaturePopups_Utils = {};

 /**
 * Function: createPopupObjs
 *
 * Parameters:
 * environments - {<GFeaturePopups>}|Array()
 * popupOptions - {Object}
 * popupDefaults - {Object}
 *
 * Returns:
 * {Object of <GFeaturePopups.Popup>}
 */
GFeaturePopups_Utils.createPopupObjs =
                           function(environments, popupOptions, popupDefaults) {
    var popupManager = GFeaturePopups.Popup,
 ...
 *
 */
GFeaturePopups_Utils.showListPopup = function(
 ...
 */
GFeaturePopups_Utils.getLocationFromHandler =
...
/**
 * Class: GFeaturePopups.Popup
 */
GFeaturePopups.Popup = OpenLayers.Class({
    /**
     * APIProperty: events
     ...
     * Only required to use <GFeaturePopups> with 2.11 or less
     */
     ...
     * Array(<GFeaturePopups>) First item is the control
     *     that initialized this popup manager.
     */
    environments: null,

    /** Property: control
     * {<GFeaturePopups>} The control that initialized this
     *     popup manager.
     */
    control: null,
    ...
    /** Property: origin
     * {<GFeaturePopups.Popup>} Popup from where requested
    ...
    /**
     * Constructor: GFeaturePopups.Popup
     * This class is a handler that is responsible for displaying and clear the
     *     one kind of popups managed by a <GFeaturePopups>.
     *
     ...
     *
     * Parameters:
     * environments - {<GFeaturePopups>}|Array() The control
     ...
     * origin - {<GFeaturePopups.Popup>|null} Popup from where
    ...
    CLASS_NAME: 'GFeaturePopups.Popup'
});

/**
 * Class: GFeaturePopups.Layer
 */
GFeaturePopups.Layer = OpenLayers.Class({
    /**
     * APIProperty: events
     * {<OpenLayers.Events>} Events instance for listeners and triggering
     *     specific events.
    ...
    /**
     * Property: popupObj
     * <GFeaturePopups.Popup> Internal use.
     */
    popupObj: null,
    ...
    /**
     * Constructor: GFeaturePopups.Layer
     */
    ...
    highlightFeature: function(feature) {
        ...
        if (template) {
            var lonLat = GFeaturePopups_Utils
                            .getLocationFromHandler(
     ...
     *    contains <GFeaturePopups.SAFE_SELECTION>.
     *
     * Parameters:
     * evt - {Object}
     */
     ...
     *     <mode> = <GFeaturePopups.CLOSE_ON_REMOVE>
     *
     * Parameters:
     * evt - {Object}
     */
     ...
     *    conbtains <GFeaturePopups.SAFE_SELECTION>.
     *
     * Parameters:
     * evt - {Object}
     */
     ...
     * origin - {<GFeaturePopups.Popup>|null}
     */
    ...
    CLASS_NAME: 'GFeaturePopups.Layer'
});