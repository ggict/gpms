 ...
 * 2015.08.27      윤은희       1.1             GDrawPath,DrawCustomPoint Class 추가
 */
    ...
    initialize: function (map, options) {
        ...
        for (var i = 0, il = this.featureTypes.length; i < il; i++) {
            if (this.featureTypes[i] == 'polygon') {
                ...
                this.activeControls.push('GDrawHole');
            }
        ...
        for (var i = 0, len = editor.activeControls.length; i < len; i++) {
            ...
            switch (control) {
                ...
                case 'CustomTransformFeature':
                    controls.push(new GTransformFeature(editor.editLayer,editor.refLayer,
                            OpenLayers.Util.extend(
                                    {
                                    	id: control
                ...
                case 'GDrawHole':
                    controls.push(new GDrawHole(editor.editLayer,
                            OpenLayers.Util.extend(
                                    {
                                    	id: control
                ...
                case 'DrawRefLine':
                    controls.push(new GDrawFeature(editor.refLayer, GPath, {
    					id : 'DrawRefLine',
    					handlerOptions : {
    						attributes : {}
    					},
