...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		if(this.p.multiselect) {
			this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox' onclick='return false;' /><label for='cb_"+this.p.id+"' class='hiddenLabel'>선택</label>");
