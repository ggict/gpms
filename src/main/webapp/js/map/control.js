MAP.CONTROL = (function($, undefined) {
    ...
    var fn_add_mapControl = function() {
        ...
        $(".mtBtn").bind("click", function() {
            ...
            for (var i = 0; i < wndpop.length; i++) {
                ...
                if (wndidBody.hasClass("left-tool")) {
        ...
        $("#btn_addCellsFromInput").on("click", function(e) {
            ...
            MAP.fn_get_getFeatureAndDrawByAttr({
                ...
                tables: ["CELL_10"],
                fields: [
                    ["ROUTE_CODE", "DIRECT_CODE", "TRACK", "STRTPT", "ENDPT"]
                ],
                values: [
                    [sRouteCode, sDirectCode, sTrack, sStrtpt, sEndpt]
                ],
                attribute: {
                    attributes: {
                        fillColor: '#0033ff',
    ...
    var init_inteSelRange = function() {
        ...
        selRouteControl.events.on({
            callback: cb_selRouteControl
        });
        ...
        if (res.data != undefined && res.data.length > 0) {
            ...
            if (oTempLyr.features.length > 1) {
                ...
                MAP.fn_get_getFeatureAndDrawByAttr({
                    ...
                    values: [
                        [o1stCell.ROUTE_CODE, o1stCell.DIRECT_CODE, o1stCell.TRACK, nStrtpt, nEndpt]
                    ],
                    attribute: {
                        attributes: {
                            fillColor: '#0033ff',
