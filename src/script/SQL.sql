...
ALTER TABLE TN_SRVY_REQUST_SCTN ADD SRVY_REQUST_INSTT VARCHAR(200);
COMMENT ON COLUMN TN_SRVY_REQUST_SCTN.SRVY_REQUST_INSTT IS '조사_요청_기관';



ALTER TABLE TN_RPAIR_TRGET_SLCTN ADD PROGRS_RT VARCHAR(20);
COMMENT ON COLUMN TN_RPAIR_TRGET_SLCTN.PROGRS_RT IS '진행_률';