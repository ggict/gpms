...
package kr.go.gg.gpms.smdtalaststtus.service.model;
 ...
 * 집계_자료_최신_현황
 *
 * @Class Name : SmDtaLastSttusVO.java
 * @Description : SmDtaLastSttus VO class
...
public class SmDtaLastSttusVO extends BaseVO {

	public SmDtaLastSttusVO() {
		super();
	}

	/**
	 * TN_SM_DTA_LAST_STTUS.SM_NO,
	 * 집계_자료_최신_현황.집계_번호
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.SRVY_YEAR,
	 * 집계_자료_최신_현황.조사_년도
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.ROUTE_CODE,
	 * 집계_자료_최신_현황.노선_코드
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.DIRECT_CODE,
	 * 집계_자료_최신_현황.행선_코드
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.VRTCAL_CR,
	 * 집계_자료_최신_현황.종방향_균열
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.HRZNTAL_CR,
	 * 집계_자료_최신_현황.횡방향_균열
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.CNSTRCT_JOINT_CR,
	 * 집계_자료_최신_현황.시공_줄눈_균열
	 */
	@XmlElement
	private java.lang.String CNSTRCT_JOINT_CR;

	/**
	 * TN_SM_DTA_LAST_STTUS.TRTS_BAC_CR,
	 * 집계_자료_최신_현황.거북등_균열
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.CNTL_DFECT,
	 * 집계_자료_최신_현황.지배_결함
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.DELETE_AT,
	 * 집계_자료_최신_현황.삭제_여부
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.UPDUSR_NO,
	 * 집계_자료_최신_현황.수정자_번호
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.FRMULA_NO,
	 * 집계_자료_최신_현황.수식_번호
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.TRNSPORT_QY,
	 * 집계_자료_최신_현황.교통_량
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.IRI_GRAD,
	 * 집계_자료_최신_현황.종단평탄성_등급
	 */
	@XmlElement
	private java.lang.String IRI_GRAD;

	/**
	 * TN_SM_DTA_LAST_STTUS.RI_IDX,
	 * 집계_자료_최신_현황.평탄성_지수
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.XCR,
	 * 집계_자료_최신_현황.NHPCI_균열
	 */
	@XmlElement
	private java.lang.String XCR;

	/**
	 * TN_SM_DTA_LAST_STTUS.RCI,
	 * 집계_자료_최신_현황.표면_조도_지수
	 */
	@XmlElement
	private java.lang.String RCI;

	/**
	 * TN_SM_DTA_LAST_STTUS.SCR,
	 * 집계_자료_최신_현황.표면_상태_지수
	 */
	@XmlElement
	private java.lang.String SCR;

	/**
	 * TN_SM_DTA_LAST_STTUS.AC_LOW,
	 * 집계_자료_최신_현황.거북등균열_LOW
	 */
	@XmlElement
	private java.lang.String AC_LOW;

	/**
	 * TN_SM_DTA_LAST_STTUS.AC_MED,
	 * 집계_자료_최신_현황.거북등균열_MED
	 */
	@XmlElement
	private java.lang.String AC_MED;

	/**
	 * TN_SM_DTA_LAST_STTUS.AC_HI,
	 * 집계_자료_최신_현황.거북등균열_HI
	 */
	@XmlElement
	private java.lang.String AC_HI;

	/**
	 * TN_SM_DTA_LAST_STTUS.LC_LOW,
	 * 집계_자료_최신_현황.종방향균열_LOW
	 */
	@XmlElement
	private java.lang.String LC_LOW;

	/**
	 * TN_SM_DTA_LAST_STTUS.LC_MED,
	 * 집계_자료_최신_현황.종방향균열_MED
	 */
	@XmlElement
	private java.lang.String LC_MED;

	/**
	 * TN_SM_DTA_LAST_STTUS.LC_HI,
	 * 집계_자료_최신_현황.종방향균열_HI
	 */
	@XmlElement
	private java.lang.String LC_HI;

	/**
	 * TN_SM_DTA_LAST_STTUS.TC_LOW,
	 * 집계_자료_최신_현황.횡방향균열_LOW
	 */
	@XmlElement
	private java.lang.String TC_LOW;

	/**
	 * TN_SM_DTA_LAST_STTUS.TC_MED,
	 * 집계_자료_최신_현황.횡방향균열_MED
	 */
	@XmlElement
	private java.lang.String TC_MED;

	/**
	 * TN_SM_DTA_LAST_STTUS.TC_HI,
	 * 집계_자료_최신_현황.횡방향균열_HI
	 */
	@XmlElement
	private java.lang.String TC_HI;

	/**
	 * TN_SM_DTA_LAST_STTUS.RD_LOW,
	 * 집계_자료_최신_현황.소성변형_LOW
	 */
	@XmlElement
	private java.lang.String RD_LOW;

	/**
	 * TN_SM_DTA_LAST_STTUS.RD_MED,
	 * 집계_자료_최신_현황.소성변형_MED
	 */
	@XmlElement
	private java.lang.String RD_MED;

	/**
	 * TN_SM_DTA_LAST_STTUS.RD_HI,
	 * 집계_자료_최신_현황.소성변형_HI
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.AC_IDX,
	 * 집계_자료_최신_현황.거북등균열_지수
	 */
	@XmlElement
	private java.lang.String AC_IDX;

	/**
	 * TN_SM_DTA_LAST_STTUS.LC_IDX,
	 * 집계_자료_최신_현황.종방향균열_지수
	 */
	@XmlElement
	private java.lang.String LC_IDX;

	/**
	 * TN_SM_DTA_LAST_STTUS.TC_IDX,
	 * 집계_자료_최신_현황.횡방향균열_지수
	 */
	@XmlElement
	private java.lang.String TC_IDX;

	/**
	 * TN_SM_DTA_LAST_STTUS.PTCHG_IDX,
	 * 집계_자료_최신_현황.패칭_지수
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.POTHOLE_CR,
	 * 집계_자료_최신_현황.포트홀_균열
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.BLOCK_CR_LOW,
	 * 집계_자료_최신_현황.블럭_균열_LOW
	 */
	@XmlElement
	private java.lang.String BLOCK_CR_LOW;

	/**
	 * TN_SM_DTA_LAST_STTUS.BLOCK_CR_MED,
	 * 집계_자료_최신_현황.블럭_균열_MED
	 */
	@XmlElement
	private java.lang.String BLOCK_CR_MED;

	/**
	 * TN_SM_DTA_LAST_STTUS.BLOCK_CR_HI,
	 * 집계_자료_최신_현황.블럭_균열_HI
	 */
	@XmlElement
	private java.lang.String BLOCK_CR_HI;

	/**
	 * TN_SM_DTA_LAST_STTUS.POTHOLE_IDX,
	 * 집계_자료_최신_현황.포트홀_지수
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.DMG_CUZ_CLMT,
	 * 집계_자료_최신_현황.파손_원인_기후
	 */
	@XmlElement
	private java.lang.String DMG_CUZ_CLMT;

	/**
	 * TN_SM_DTA_LAST_STTUS.DMG_CUZ_VMTC,
	 * 집계_자료_최신_현황.파손_원인_교통량
	 */
	@XmlElement
	private java.lang.String DMG_CUZ_VMTC;

	/**
	 * TN_SM_DTA_LAST_STTUS.DMG_CUZ_ETC,
	 * 집계_자료_최신_현황.파손_원인_기타
	 */
	@XmlElement
	private java.lang.String DMG_CUZ_ETC;

	/**
	 * TN_SM_DTA_LAST_STTUS.BC_IDX,
	 * 집계_자료_최신_현황.블럭균열_지수
	 */
	@XmlElement
	...
	/**
	 * TN_SM_DTA_LAST_STTUS.CALC_YEAR,
	 * 집계_자료_최신_현황.산정_년도
	 */
	@XmlElement
	...
	@XmlElement
	private java.lang.String CALC_STTUS;
     ...
     */
    @XmlElement
    private java.lang.String SECT_SE;
     ...
     */
    @XmlElement
    private java.lang.String RPAIR_TA;
     ...
     */
    @XmlElement
    private java.lang.String ROAD_GPCI_1;

    /**
     * 지방도 GPCI
     */
    @XmlElement
    private java.lang.String ROAD_GPCI_2;

    /**
     * 도로등급별 전체 GPCI
     */
    @XmlElement
    private java.lang.String ROAD_GPCI_3;

    /**
     * 도로건설과 GPCI
     */
    @XmlElement
    private java.lang.String DEPT_GPCI_1;

    /**
     * 북부도로과 GPCI
     */
    @XmlElement
    private java.lang.String DEPT_GPCI_2;

    /**
     * 부서별 전체 GPCI
     */
    @XmlElement
    private java.lang.String DEPT_GPCI_3;
	...
	@JsonProperty(value="CALC_STTUS")
	public java.lang.String getCALC_STTUS() {
		return this.CALC_STTUS;
	}

	public void setCALC_STTUS(java.lang.String cALC_STTUS) {
		this.CALC_STTUS = cALC_STTUS;
	}
    ...
    @JsonProperty(value="SECT_SE")
    public java.lang.String getSECT_SE() {
        return SECT_SE;
    }

    public void setSECT_SE(java.lang.String sECT_SE) {
        SECT_SE = sECT_SE;
    }
    ...
    @JsonProperty(value="RPAIR_TA")
    public java.lang.String getRPAIR_TA() {
        return RPAIR_TA;
    }

    public void setRPAIR_TA(java.lang.String rPAIR_TA) {
        RPAIR_TA = rPAIR_TA;
    }
    ...
    @JsonProperty(value="ROAD_GPCI_1")
	public java.lang.String getROAD_GPCI_1() {
		return ROAD_GPCI_1;
	}

	public void setROAD_GPCI_1(java.lang.String rOAD_GPCI_1) {
		ROAD_GPCI_1 = rOAD_GPCI_1;
	}

	@JsonProperty(value="ROAD_GPCI_2")
	public java.lang.String getROAD_GPCI_2() {
		return ROAD_GPCI_2;
	}


	public void setROAD_GPCI_2(java.lang.String rOAD_GPCI_2) {
		ROAD_GPCI_2 = rOAD_GPCI_2;
	}

	@JsonProperty(value="ROAD_GPCI_3")
	public java.lang.String getROAD_GPCI_3() {
		return ROAD_GPCI_3;
	}

	public void setROAD_GPCI_3(java.lang.String rOAD_GPCI_3) {
		ROAD_GPCI_3 = rOAD_GPCI_3;
	}

	@JsonProperty(value="DEPT_GPCI_1")
	public java.lang.String getDEPT_GPCI_1() {
		return DEPT_GPCI_1;
	}

	public void setDEPT_GPCI_1(java.lang.String dEPT_GPCI_1) {
		DEPT_GPCI_1 = dEPT_GPCI_1;
	}

	@JsonProperty(value="DEPT_GPCI_2")
	public java.lang.String getDEPT_GPCI_2() {
		return DEPT_GPCI_2;
	}

	public void setDEPT_GPCI_2(java.lang.String dEPT_GPCI_2) {
		DEPT_GPCI_2 = dEPT_GPCI_2;
	}

	@JsonProperty(value="DEPT_GPCI_3")
	public java.lang.String getDEPT_GPCI_3() {
		return DEPT_GPCI_3;
	}

	public void setDEPT_GPCI_3(java.lang.String dEPT_GPCI_3) {
		DEPT_GPCI_3 = dEPT_GPCI_3;
	}
