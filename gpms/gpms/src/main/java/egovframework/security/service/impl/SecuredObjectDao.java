...
*/
    public static final String  DEF_ROLES_AND_URL_QUERY ="SELECT "
+ "    tnauthority.AUTHOR_ID AS AUTHORITY "
+ "    , LOWER(tnmenu.URL) URL   "
+ "FROM TN_AUTHORITY tnauthority "
+ "INNER JOIN TN_ROLE_MENU tnrolemenu "
+ "ON tnrolemenu.AUTHOR_ID = tnauthority.AUTHOR_ID  AND tnrolemenu.DELETE_AT ='N' " 
+ "INNER JOIN TN_MENU tnmenu "
+ "ON tnmenu.MENU_ID = tnrolemenu.MENU_ID   AND tnmenu.USE_AT ='Y'  AND tnmenu.DELETE_AT ='N' "  
+ "WHERE 1 = 1 "
+ "AND tnauthority.USE_AT ='Y'  AND tnauthority.DELETE_AT ='N' "  
+ "ORDER BY tnmenu.URL ASC ";
    /**
    ...
    public LinkedHashMap<Object, List<ConfigAttribute>> getRolesAndResources(String resourceType) throws Exception {
        ...
        //List<RoleMenuVO> roleAndUrls = (List<RoleMenuVO>)list("roleMenuDAO.selectRoleMenuURLList", roleMenuVO);
        //List<Map<String, Object>> resultList = new LinkedList<Map<String, Object>>();
        //for(RoleMenuVO roleandUrl : roleAndUrls){
        	//resultList.
        //}
    ...
    public List<ConfigAttribute> getRegexMatchedRequestMapping(String url) throws Exception {
       ...
       // List<Map<String, Object>> resultList = null;
        ...
        if (configList.size() > 0) {
        	logger.debug( String.format("Request Uri : {%s}, matched Uri : {%s}, mapping Roles : {%s}", url, resultList.get(0).get("uri"), configList));
        	//logger.debug( "Request Uri : {}, matched Uri : {}, mapping Roles : {}", (Object)url, resultList.get(0).get("uri"), (Object)configList);
