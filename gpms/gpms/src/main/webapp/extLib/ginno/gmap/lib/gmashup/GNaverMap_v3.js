...
GNaverMap_v3 = OpenLayers.Class({
	...
	initialize: function (div, options) {
		...
		var latlng = new naver.maps.LatLng(center.lon, center.lat);
...
//		var map = new NMap(this.div, naverMapOption);
		var map = new naver.maps.Map(this.div, naverMapOption);
		map.setCenter(naverMapOption.point);
		map.setZoom(12 - this.oMap.getZoom());
