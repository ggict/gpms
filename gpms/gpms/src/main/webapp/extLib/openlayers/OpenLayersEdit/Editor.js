 ...
 *
 * 파일명 : Editor.js
 * 설  명 : OpenLayers를 이용한 편집기능 제공 JavaScript
 *
 *    수정일      수정자     Version        Function 명
 * ------------    ---------   -------------  ----------------------------
 * 2015.07.27    	최재훈       1.0             최초수정
 *
 */
        ...
        if (options.styleMap) {
            ...
            this.editLayer.styleMap = new OpenLayers.StyleMap({
                ...
                'defaultLabel': new OpenLayers.Style({
                    ...
                    /*fontFamily: "NanumGothic, 돋움, Dotum, Arial, sans-serif",*/
                    fontWeight: "bold",
//					labelAlign: "cm",
//					labelXOffset: 0,
//					labelYOffset: 0,
    ...
    addEditorControls: function () {
        ...
        for (var i = 0, len = editor.activeControls.length; i < len; i++) {
            ...
            if (OpenLayers.Util.indexOf(editor.editorControls, control) > -1) {
                controls.push(new OpenLayers.Editor.Control[control](editor.editLayer, editor.options[control] ));
            }
