var define, require, esl,se;
var chartExcelMap = new javascript.util.HashMap();
!function (e) {
	function t(e) {
		m(e, J) || (O[e] = 1)
	}
...
(this), define("echarts", ["echarts/echarts"], function (e) {
				...
				if (u) {
					...
					if (g[V](t), f[V](t), n || (g[U](), t = f[U]()), null != r) {
						...
						if (u.type === a.CHART_TYPE_PIE && (y = d.legend) && (b = y.data)) {
							...
							v,
							L = u.xAxisIndex || 0;
							(null == d.xAxis[L].type || "category" === d.xAxis[L].type) && (k = d.xAxis[L].data, v = h.xAxis[L].data, k[V](r), v[V](r), n || (k[U](), v[U]())),
							L = u.yAxisIndex || 0,
	...
	function t(e, t, n, a, o) {
		...
		r._onSaveAsExcel = function (e) {
			var tempse = "";
			se = "";
			tempse = chartExcelMap.get(e.event.currentTarget.id);
			if(tempse!=null && tempse!="" && tempse!=undefined){
				se = tempse;
			}
			else{
				se = e.event.currentTarget.id;
			}
			
			if(e.event.currentTarget.id == "mRoutLenChart"){
				se = "rout";
			}else if(e.event.currentTarget.id == "mDeptLenChart"){
				se = "dept";
			}else if(e.event.currentTarget.id == "mRoadLenChart"){
				se = "road";
			}else if(e.event.currentTarget.id == "mTrackLenChart"){
				se = "track";
			}else if(e.event.currentTarget.id == "gpmsGradLenPieChart"){
				se = "gpmsGradLenPieChart";
			}else if(e.event.currentTarget.id == "gpmsLenBarChart"){
				se = "gpmsLenBarChart";
			}
	...
	return t.prototype = {
		...
		__onDataView : function () {
			//return this._dataView.show("ttttt"),
		...
		__onSaveAsImage : function () {
			...
			a.innerHTML = '<img style="vertical-align:middle" src="' + i + '" title="' + (window.ActiveXObject || "ActiveXObject" in window ? "마우스 오른쪽 클릭 -> 이미지 저장" : e.lang ? e.lang[0] : "点击保存") + '"/>',
			n.appendChild(a),
	...
	return t.prototype = {
		...
		_getChainPoint : function () {
			...
			for (var g, f, y, b, _, x = [], U = 0; p > U; U++)
				d = u[U], g = h[U].symbol && h[U].symbol.toLowerCase() || n, g.match("empty") ? (g = g.replace("empty", ""), y = !0) : y = !1, g.match("star") && (f = g.replace("star", "") - 0 || 5, g = "star"), t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r, b = t.align || "center", o ? (b = o > 0 ? "right" : "left", _ = [o * Math.PI / 180, d, c - 5]) : _ = !1, x.push({
					x : d,
					n : f,
					isEmpty : y,
					symbol : g,
		...
		_markPoint : function (e, t) {
			...
			if (t.large)
				...
				for (var b = 0, _ = u.length; _ > b; b++)
					null != u[b].x && null != u[b].y && (r = null != u[b].value ? u[b].value : "", g && (o = g.getColor(i.name)), V && (o = isNaN(r) ? o : V.getColor(r), s = [u[b], t], l = this.deepQuery(s, "itemStyle.normal.color") || o, c = this.deepQuery(s, "itemStyle.emphasis.color") || l, null == l && null == c) || (o = null == o ? this.zr.getColor(e) : o, u[b].tooltip = u[b].tooltip || t.tooltip || {
								trigger : "item"
	...
	function t(e, t, n, a, o) {
		...
		this._textArea = document.createElement("div"),			//@@ ("textarea") 에서 변경함.
	...
	return t.prototype = {
		...
		_gCssText : "cursor:default;position:absolute;display:block;overflow:hidden;transition:height 0.8s,background-color 1s;-moz-transition:height 0.8s,background-color 1s;-webkit-transition:height 0.8s,background-color 1s;-o-transition:height 0.8s,background-color 1s;z-index:1;left:0;top:0;",
		hide : function () {
		...
		show : function (e) {			//@@ dataView box 생성
			this._hasShow = !0;
			var t = this.query(this.option, "toolbox.feature.dataView.lang") || this._lang;		// this lang 또는 _lang
			// 2depth title
			var t_depth2 ="";
			$(".Left_Mbx div li").each(function(i, e){
				if( $(".Left_Mbx div li a:eq("+i+")").hasClass("selected2")==true ){
					t_depth2 = $(".Left_Mbx div li a:eq("+i+")").text();
				}
			});
			// 1depth title
			var t_depth1 ="";
			$(".Left_Mbx div").each(function(i, e){	
				if( $(".Left_Mbx div a:eq("+i+")").hasClass("selected")==true ){
					t_depth1 = $(".Left_Mbx div a:eq("+i+")").text();
				}
			});
			this.option = e,
			this._tDom.innerHTML = '<p style="padding:8px 0;display:none;margin:0 0 10px 0;background-color:#F6F6F6; font-weight:bold; color:#353535; font-family:NanumGothic;">' + (t_depth2?t_depth2:t_depth1) + "</p>";		//+ (t[0] || this._lang[0]) +
			...
			//this._textArea.id = "detailViewId",	//@@ id 부여
			this._textArea.innerHTML = (e.toolbox.feature.dataView.id == null ? $(".cont_ListBx").html() :  $("#" + e.toolbox.feature.dataView.id + " .cont_ListBx").html());
			this._textArea.style.cssText = "display:block;margin:0 0 8px 0;padding:4px 6px;overflow:auto;width:98%;height:" + (this._zrHeight - 50) + "px;", //120
			this._tDom.appendChild(this._textArea),
			this._buttonClose.style.cssText = "float:right;padding:5px 10px;background-color:#F0F0F0;color:#003399;border:1px solid #d9d9d9;font-weight:bold; margin:0px 10px",
			...
			/*this.query(this.option, "toolbox.feature.dataView.readOnly") === !1 ? (this._buttonRefresh.style.cssText = "float:right;margin-right:10px;padding:1px 6px;", this._buttonRefresh.innerHTML = t[2] || this._lang[2], this._buttonRefresh.onclick = function () {
				n._save()
			}, this._textArea.readOnly = !0, this._textArea.style.cursor = "default") : (this._buttonRefresh.style.cssText = "display:none", this._textArea.readOnly = !0, this._textArea.style.cursor = "text"),
			this._tDom.appendChild(this._buttonRefresh),*/	//refresh(save) 버튼 주석처리
		...
		dispose : function () {
			...
			this._hasShow && (this._tDom.removeChild(this._textArea), this._tDom.removeChild(this._buttonClose)),
			this._textArea = null,
	...
	return t.prototype = {
		...
		_synScatterData : function (e, t) {
			...
			var h;
			(h = l.x.dataMappingMethods) && (n = h.coord2Value(n), a = h.coord2Value(a)),
		...
		_buildAxisTick : function () {
			...
			if (this.isHorizontal())
				for (var p, u = "bottom" == this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, V = m; i > V; V += h)
					(!l || l(V, t[V])) && (p = this.subPixelOptimize(this.getCoordByIndex(V) + (V >= 0 ? c : 0), s), e = {
							_axisShape : "axisTick",
							zlevel : this.getZlevelBase(),
							z : this.getZBase(),
							hoverable : !1,
				...
				for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = m; i > V; V += h)
					(!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? c : 0), s), e = {
							_axisShape : "axisTick",
							zlevel : this.getZlevelBase(),
							z : this.getZBase(),
							hoverable : !1,
		...
		_buildAxisLabel : function () {
			...
			if (this.isHorizontal()) {
				...
				for (var u = 0; a > u; u += this._interval)
					c && !c(u, i[u]) || "" === this._getReformedLabel(u) || (t = s.merge(i[u].textStyle || {}, d), e = {
							zlevel : this.getZlevelBase(),
							z : this.getZBase() + 3,
							hoverable : !1,
							style : {
		...
		_buildSplitLine : function () {
			...
			if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0, this.isHorizontal())
				for (var m, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)
					(!h || h(V, t[V])) && (m = this.subPixelOptimize(this.getCoordByIndex(V) + c, r), e = {
							zlevel : this.getZlevelBase(),
							z : this.getZBase(),
							hoverable : !1,
							style : {
				...
				for (var U, g = this.grid.getX(), f = this.grid.getXend(), V = 0; i > V; V += this._interval)
					(!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - c, r), e = {
							zlevel : this.getZlevelBase(),
							z : this.getZBase(),
							hoverable : !1,
							style : {
		...
		_buildAxisTick : function () {
			...
			this.shapeList.push(new a(e));
				...
				for (var c, m = "left" === this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, d = 0; i > d; d++)
					c = this.subPixelOptimize(this.getCoord(t[d]), s), e = {
						_axisShape : "axisTick",
						zlevel : this.getZlevelBase(),
						z : this.getZBase(),
						hoverable : !1,
		...
		_buildSplitLine : function () {
			...
			if (this.isHorizontal())
				for (var h, d = this.grid.getY(), c = this.grid.getYend(), m = 0; i > m; m++)
					h = this.subPixelOptimize(this.getCoord(t[m]), r), e = {
						zlevel : this.getZlevelBase(),
						z : this.getZBase(),
						hoverable : !1,
						style : {
			...
			this.shapeList.push(new a(e));
				...
				for (var p, u = this.grid.getX(), V = this.grid.getXend(), m = 0; i > m; m++)
					p = this.subPixelOptimize(this.getCoord(t[m]), r), e = {
						zlevel : this.getZlevelBase(),
						z : this.getZBase(),
						hoverable : !1,
						style : {
			...
			if (t instanceof Array) {
				...
				h = r;
					...
					for (var c, m = this.grid.getX(), p = this.grid.getWidth(), u = this.grid.getYend(), d = 0; a >= d; d++)
						c = a > d ? this.getCoord(n[d]) : this.grid.getY(), e = {
							zlevel : this.getZlevelBase(),
							z : this.getZBase(),
							hoverable : !1,
							style : {
