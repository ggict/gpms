...
<div style="padding: 20px;" class="a4">
	...
	<div class="printCont">
		<p>◉ 개인 정보 수집 동의</p>
		<span class="msg">경기도로 모니터링단 시스템에서는 사용자 확인, 권한관리 등 서비스 제공을 위해 아래와 같은 최소한의 개인정보를 수집하고 있습니다.</span>		
		
		<p>1. 수집하는 개인정보의 항목</p>
		<span class="msg">성명, 부서, 전화번호, 이메일 등</span>
		
		<p>2. 개인정보 수집 방법</p>
		<span class="msg">경기도로 모니터링단 시스템은 다음과 같은 방법으로 개인정보를 수집합니다.
 ...
 - 권한처리 및 관리를 위한 정보 활용</span>
		...
		<span class="msg">경기도로 모니터링단 시스템에서는 수집된 정보를 제3자에게 제공하지
  않습니다.</span>
